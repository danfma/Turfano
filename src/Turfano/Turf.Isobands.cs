// filepath: /Users/danfma/Develop/private/Turfano/src/Turfano/Turf.Isobands.cs
namespace Turfano;
...
public static partial class Turf
{
    ...
    )
    {
        ...
        // Close the polygon
        if (
            !TurfUtils.ArePointsClose(polygonCoords[0], polygonCoords[polygonCoords.Count - 1])
        )
        {
